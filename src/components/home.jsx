...
const Home =()=>{
    ...
    <div className="home_main_div">
        <div className="home_grid_cases">
            ...
            <Link className="grid_case" to="/case/prism2">
                <div className=" ">
            ...
            <Link className="grid_case" to="/case/clutch">
                <div className=" ">
            ...
            <Link className="grid_case" to="/case/hydra">
                <div className=" ">
            ...
            <Link className="grid_case" to="/case/glove">
                <div className=" ">
            ...
            <Link className="grid_case" to="/case/gamma">
                <div className=" ">
            ...
            <Link className="grid_case" to="/case/spectrum2">
                <div className=" ">
